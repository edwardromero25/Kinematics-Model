...
class CustomToolbar(NavigationToolbar2Tk):
    def __init__(self, canvas, parent, export_magnitude_callback=None, export_components_callback=None, export_distribution_callback=None, export_animation_callback=None):
        ...
        if export_magnitude_callback:
            self.toolitems.append(("ExportMagnitude", "Export data to CSV", "filesave", "export_magnitude_data"))
...
class GUI:
    ...
    def setup_theoretical_plot_frames(self):
        ...
        self.theoretical_g_acceleration_ax.set_xlabel('Time (hours)')
        ...
        self.theoretical_g_components_ax.set_xlabel('Time (hours)')
        ...
        self.theoretical_non_g_acceleration_ax.set_xlabel('Time (hours)')
        ...
        self.theoretical_non_g_components_ax.set_xlabel('Time (hours)')
    ...
    def setup_experimental_plot_frames(self):
        ...
        self.experimental_g_acceleration_ax_left.set_xlabel('Time (hours)')
        ...
        self.experimental_g_acceleration_ax_right.set_xlabel('Time (hours)')
