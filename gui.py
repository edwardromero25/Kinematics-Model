...
class GUI:
    ...
    def setup_gravitational_acceleration_plot(self):
        ...
        self.gravitational_acceleration_toolbar_left = NavigationToolbar2Tk(self.gravitational_acceleration_canvas_left, self.gravitational_acceleration_frame_left)
        ...
        self.gravitational_acceleration_toolbar_right = NavigationToolbar2Tk(self.gravitational_acceleration_canvas_right, self.gravitational_acceleration_frame_right)
    ...
    def setup_acceleration_distribution_plots(self):
        ...
        self.acceleration_distribution_canvas.get_tk_widget().pack(side=tk.TOP, fill=tk.BOTH, expand=True)
        self.acceleration_distribution_toolbar = NavigationToolbar2Tk(self.acceleration_distribution_canvas, self.acceleration_distribution_frame_left)
        self.acceleration_distribution_toolbar.pack(side=tk.BOTTOM, fill=tk.X)
        self.acceleration_distribution_frame_left.grid(row=0, column=0, sticky="nsew")
        self.acceleration_distribution_figure_analysis = plt.Figure()
        self.acceleration_distribution_ax_analysis = self.acceleration_distribution_figure_analysis.add_subplot(1, 1, 1, projection='3d')
        ...
        self.acceleration_distribution_canvas_analysis = FigureCanvasTkAgg(self.acceleration_distribution_figure_analysis, self.acceleration_distribution_frame_right)
        self.acceleration_distribution_canvas_analysis.get_tk_widget().pack(side=tk.TOP, fill=tk.BOTH, expand=True)
        self.acceleration_distribution_toolbar_analysis = NavigationToolbar2Tk(self.acceleration_distribution_canvas_analysis, self.acceleration_distribution_frame_right)
        self.acceleration_distribution_toolbar_analysis.pack(side=tk.BOTTOM, fill=tk.X)
    ...
    def show_3d_rigid_body_inputs(self):
        ...
        if not hasattr(self, 'rigid_body_tabs_created') or not self.rigid_body_tabs_created:
            ...
            self.rigid_body_gravitational_components_toolbar = NavigationToolbar2Tk(self.rigid_body_gravitational_components_canvas, self.rigid_body_gravitational_acceleration_frame_right)
            ...
            self.rigid_body_gravitational_acceleration_toolbar = NavigationToolbar2Tk(self.rigid_body_gravitational_acceleration_canvas, self.rigid_body_gravitational_acceleration_frame_left)
            self.rigid_body_gravitational_acceleration_toolbar.update()
            self.rigid_body_non_gravitational_acceleration_toolbar = NavigationToolbar2Tk(self.rigid_body_non_gravitational_acceleration_canvas, self.rigid_body_non_gravitational_acceleration_frame_left)
            self.rigid_body_non_gravitational_acceleration_toolbar.update()
            self.rigid_body_acceleration_distribution_toolbar = NavigationToolbar2Tk(self.rigid_body_acceleration_distribution_canvas, self.rigid_body_acceleration_distribution_frame_left)
            self.rigid_body_acceleration_distribution_toolbar.update()
            self.rigid_body_acceleration_distribution_analysis_toolbar = NavigationToolbar2Tk(self.rigid_body_acceleration_distribution_analysis_canvas, self.rigid_body_acceleration_distribution_frame_right)
    ...
    def clear_rigid_body_tabs(self):
        ...
        self.rigid_body_non_gravitational_components_toolbar = NavigationToolbar2Tk(self.rigid_body_non_gravitational_components_canvas, self.rigid_body_non_gravitational_acceleration_frame_right)
    ...
    def update_rigid_body_non_gravitational_components_plot(self, time_array, a_x_avg, a_y_avg, a_z_avg):
        ...
        self.rigid_body_non_gravitational_components_canvas.draw()
        if not hasattr(self, 'rigid_body_non_gravitational_components_toolbar'):
            self.rigid_body_non_gravitational_components_toolbar = NavigationToolbar2Tk(self.rigid_body_non_gravitational_components_canvas, self.rigid_body_non_gravitational_acceleration_frame_right)
            self.rigid_body_non_gravitational_components_toolbar.update()
